...
{
    public partial class MotorBikeParkingUC : UserControl
    {
        public MotorBikeParkingUC()
        {
            InitializeComponent();
        }
        private ParkingSpaceBLL bll = new ParkingSpaceBLL();
        ...
        private void LoadParkingStatus()
        {
            ...
            var spaces = bll.GetParkingSpaceInfos("Bãi Xe máy");
        ...
        private void MotorBikeParkingUC_Load(object sender, EventArgs e)
        {
            LoadParkingStatus();
