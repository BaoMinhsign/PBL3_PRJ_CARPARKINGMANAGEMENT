...
{
    public partial class BikeParkingUC: UserControl
    {
        public BikeParkingUC()
        {
            InitializeComponent();
        }
        private void LoadParkingStatus()
        {
            ...
            var spaces = bll.GetParkingSpaceInfos("Bãi Xe đạp");
        ...
        private void BikeParkingUC_Load(object sender, EventArgs e)
        {
            LoadParkingStatus();
        }
    }
